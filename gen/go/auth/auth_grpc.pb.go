...
const (
	...
	Auth_Logout_FullMethodName       = "/github.chas3air.protos.auth.Auth/Logout"
	Auth_IsAdmin_FullMethodName      = "/github.chas3air.protos.auth.Auth/IsAdmin"
	Auth_RefreshToken_FullMethodName = "/github.chas3air.protos.auth.Auth/RefreshToken"
)
...
//
// Auth service provides operations for user authentication and authorization.
type AuthClient interface {
	// Login verifies user credentials and returns access and refresh tokens.
